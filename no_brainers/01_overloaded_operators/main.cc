...
using rose::Point, rose::TestCase, rose::TestResult, rose::TestSuite;
...
int main(int argc, const char *argv[]) {
  ...
  TestSuite suite;
  suite.Add(std::make_unique<PointTest1>());
  suite.Add(std::make_unique<PointTest2>());
  suite.Add(std::make_unique<PointTest3>());
  suite.Add(std::make_unique<PointTest4>());
