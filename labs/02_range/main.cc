...
using rose::Range, rose::TestCase, rose::TestResult, rose::TestSuite;
...
int main(int argc, const char *argv[]) {
  ...
  TestSuite suite;
  suite.Add(std::make_unique<PlainIntRangeTest>());
  suite.Add(std::make_unique<IntRangeStepTest>());
  suite.Add(std::make_unique<DoubleRangeStepTest>());
  suite.Add(std::make_unique<BackwardsIntRangeTest>());
  suite.Add(std::make_unique<BackwardsDoubleRangeTest>());
