...
<table>
	...
	<tr>
		<td><a href="#inclusive-language">Inclusive Language</a></td>
		<td></td>
	</tr>
	<tr>
		<td><a href="#naming">Naming</a></td>
		<td>
			<ul>
...
> class MyClass {<br>
> &ensp;public:<br>
> &ensp;&ensp;int CountFooErrors(const std::vector<Foo>& foos) {<br>
> &ensp;&ensp;&ensp;&ensp;int n = 0;&ensp;&ensp;// Clear meaning given limited scope and context<br>
> &ensp;&ensp;&ensp;&ensp;for (const auto& foo : foos) {<br>
> &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;...<br>
> &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;++n;<br>
> &ensp;&ensp;&ensp;&ensp;}<br>
> &ensp;&ensp;&ensp;&ensp;return n;<br>
> &ensp;&ensp;}<br>
> &ensp;&ensp;void DoSomethingImportant() {<br>
> &ensp;&ensp;&ensp;&ensp;std::string fqdn = ...;&ensp;&ensp;// Well-known abbreviation for Fully Qualified Domain Name<br>
> &ensp;&ensp;}<br>
> &ensp;private:<br>
> &ensp;&ensp;const int kMaxAllowedConnections = ...;&ensp;&ensp;// Clear meaning within context<br>
> };
> </code>
...
> &ensp;public:<br>
> &ensp;&ensp;int CountFooErrors(const std::vector<Foo>& foos) {<br>
> &ensp;&ensp;&ensp;&ensp;int total_number_of_foo_errors = 0;&ensp;&ensp;// Overly verbose given limited scope and context<br>
> &ensp;&ensp;&ensp;&ensp;for (int foo_index = 0; foo_index < foos.size(); ++foo_index) {&ensp;&ensp;// Use idiomatic `i`<br>
> &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;...<br>
> &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;++total_number_of_foo_errors;<br>
> &ensp;&ensp;&ensp;&ensp;}<br>
> &ensp;&ensp;&ensp;&ensp;return total_number_of_foo_errors;<br>
> &ensp;&ensp;}<br>
> &ensp;&ensp;void DoSomethingImportant() {<br>
> &ensp;&ensp;&ensp;&ensp;int cstmr_id = ...;&ensp;&ensp;// Deletes internal letters<br>
> &ensp;&ensp;}<br>
> &ensp;private:<br>
> &ensp;&ensp;const int kNum = ...;&ensp;&ensp;// Unclear meaning within broad scope<br>
> };
> </code>
...
> class UrlTable { ...<br>
> class UrlTableTester { ...<br>
> struct UrlTableProperties { ...<br>
> <br>
> // typedefs<br>
> typedef hash_map&lt;UrlTableProperties *, std::string&gt; PropertiesMap;<br>
> <br>
> // using aliases<br>
> using PropertiesMap = hash_map&lt;UrlTableProperties *, std::string&gt;;<br>
> <br>
> // enums<br>
...
> <code>
> std::string table_name;&ensp;&ensp;// OK - snake_case.
> </code>

<br>

> <code>
> std::string tableName;&ensp;&ensp;&ensp;// Bad - mixed case.
> </code>
...
> &ensp;&ensp;...<br>
> &ensp;private:<br>
> &ensp;&ensp;std::string table_name_;&ensp;&ensp;// OK - underscore at end.<br>
> &ensp;&ensp;static Pool&lt;TableInfo&gt;* pool_;&ensp;&ensp;// OK.<br>
> };
> </code>
...
> &ensp;&ensp;int num_entries;<br>
> &ensp;&ensp;static Pool&lt;UrlTableProperties&gt;* pool;<br>
> };
> </code>
...
> const int kAndroid8_0_0 = 24;&ensp;&ensp;// Android 8.0.0
> </code>
...
> <code>
> void ComputeFoo(absl::string_view suffix) {<br>
> &ensp;&ensp;// Either of these is acceptable.<br>
> &ensp;&ensp;const absl::string_view kPrefix = "prefix";<br>
> &ensp;&ensp;const absl::string_view prefix = "prefix";<br>
> &ensp;&ensp;...<br>
> }<br>
> </code>
...
> <code>
> void ComputeFoo(absl::string_view suffix) {<br>
> &ensp;&ensp;// Bad - different invocations of ComputeFoo give kCombined different values.<br>
> &ensp;&ensp;const std::string kCombined = absl::StrCat(kPrefix, suffix);<br>
> &ensp;&ensp;...<br>
> }
> </code>
...
Namespace names are all lowercase, with words separated by underscores. Top-level namespace names are based on the project name. Avoid collisions between nested namespaces and well-known top-level namespaces.
...
> <code>
> enum class UrlTableError {<br>
> &ensp;&ensp;kOk = 0,<br>
> &ensp;&ensp;kOutOfMemory,<br>
> &ensp;&ensp;kMalformedInput,<br>
> };<br>
> <br>
> enum class AlternateUrlTableError {<br>
> &ensp;&ensp;OK = 0,<br>
> &ensp;&ensp;OUT_OF_MEMORY = 1,<br>
> &ensp;&ensp;MALFORMED_INPUT = 2,<br>
> };
> </code>
